...
public class Cekbayar extends AppCompatActivity {
    String eko,order;
    ...
    private void midtrasnsget(String order) {
        final Dialog dialogok;
        dialogok= new Dialog(Cekbayar.this);
        ...
        String UrlLogin="https://api.sandbox.midtrans.com/v2/"+order+"/status";
    ...
    private void updatetransaksi(final String order) {
        ...
        StringRequest stringRequest= new StringRequest(Request.Method.PUT, e,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("idorder",order);
                params.put("Content-Type","application/x-www-form-urlencoded");
                return params;
            }};
        RequestQueue requestQueue = Volley.newRequestQueue(Cekbayar.this);
        requestQueue.add(stringRequest);
    }
    ...
    private void getdata(String eko) {
        ...
        dialogok.setCanceledOnTouchOutside(false);
        dialogok.show();
        String UrlLogin="http://gccestatemanagement.online/public/api/transaksiss3/"+eko;
        StringRequest stringRequest= new StringRequest(Request.Method.GET, UrlLogin,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
